(function($) {
    ...
    $('nav#dropdown').meanmenu({
        siteLogo: "<div class='mobile-menu-nav-back'><a class='logo-mobile' href='/'><img src='/staticfiles/general/base/img/logo-light.png' class='mobile-logo' alt='logo' class='img-fluid'/></a></div>"
    });
